...
public class TemplateRegistry {
    ...
    public static final String JUNIT4_MOCKITO_NO_EXCEPTION_JAVA_TEMPLATE = "JUnit4 & Mockito & NoException.java";
    public static final String JUNIT5_MOCKITO_JAVA_TEMPLATE = "JUnit5 & Mockito.java";
    public static final String JUNIT5_MOCKITO_NO_EXCEPTION_JAVA_TEMPLATE = "JUnit5 & Mockito & NoException.java";
    public static final String TESTNG_MOCKITO_JAVA_TEMPLATE = "TestNG & Mockito.java";
    public static final String TESTNG_MOCKITO_NO_EXCEPTION_JAVA_TEMPLATE = "TestNG & Mockito & NoException.java";
